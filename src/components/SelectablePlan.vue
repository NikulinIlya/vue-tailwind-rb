<template>
    <div class="w-48 bg-white rounded-lg shadow-md p-6 hover:cursor-pointer mb-8  hover:bg-green-lightest
     focus:outline-none focus:shadow-outline-green" :class="{'bg-green-lightest shadow-outline-green' : this.activePlan === this.planName}"
         tabindex="0" @click="updateActivePlan" @keydown.space="updateActivePlan">
