<template>
    <div class="md:w-custom mx-auto py-8 md:flex md:justify-between md:flex-wrap">
        <div class="w-48 bg-white rounded-lg shadow-md p-6 hover:cursor-pointer mb-8 hover:bg-green-lightest
        focus:outline-none focus:shadow-outline-green" tabindex="0">
        ...
        <div class="w-48 bg-white rounded-lg shadow-md p-6 hover:cursor-pointer mb-8 bg-green-lightest hover:bg-green-lightest
        shadow-outline-green focus:outline-none focus:shadow-outline-green" tabindex="0">
            <div class="flex justify-between items-center mb-3">
                <h1 class="uppercase text-base tracking-wide text-blue-darker">Growth</h1>
                <div>
                    <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="checkmark-outline" fill-rule="nonzero">
        ...
        focus:outline-none focus:shadow-outline-green" tabindex="0">
            <div class="flex justify-between items-center mb-3">
                <h1 class="uppercase text-base tracking-wide text-blue-darker">Business</h1>
                <div>
                    <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="checkmark-outline" fill-rule="nonzero">
        ...
        focus:outline-none focus:shadow-outline-green" tabindex="0">
            <div class="flex justify-between items-center mb-3">
                <h1 class="uppercase text-base tracking-wide text-blue-darker">Enterprise</h1>
                <div>
                    <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="checkmark-outline" fill-rule="nonzero">
